                  ...
                  <div style={styles.cardHeader}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                      <div>
                        ...
                        <h3 style={{ margin: '5px 0' }}>{ev.title || ev.location}</h3>
                        {ev.title && (
                          <p style={{ margin: 0, fontSize: '12px', color: 'rgba(255,255,255,0.78)' }}>
                            {ev.location}
                          </p>
                        )}
          ...
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              <div>
                ...
                <p style={{ margin: '5px 0 0', opacity: 0.8, fontSize: '14px' }}>{selectedEvent.title || selectedEvent.location}</p>
              </div>
              <button
